...
\end{basedescript}
\paragraph{Client}~\\
Clientseitig gibt es folgende Punkte zu verbessern:
\begin{basedescript}{
	\desclabelstyle{\multilinelabel}
	\desclabelwidth{4.5cm}
	\setlength{\itemsep}{5ex}}
...
\vspace{0.5cm}
\paragraph{Fazit}~\\
Da zu Beginn der Construction RUP Phase einen gesamten Sprint geplant ist, werden diese Punkte, die teilweise mit den schon geplanten überlappen, verbessert. Dadurch verhoffen wir uns eine ausgereiftere Plattform, wo sich zukünfigt geplante aber auch ungeplante Features effizient entwickeln werden können. 